        ...
        <div className="about-wrapper">
            ...
            <div className = "about-content">
                ...
                <div className = "about-text">
                    ...
                    <p>In my free time I enjoy going to concerts, playing soccer, watching sports (Go Hawks!), and spending time with my two kittens, Taco & Tequila. A dream of mine is to become a software engineer or work with animals, or both!</p>
                </div>
            </div>
